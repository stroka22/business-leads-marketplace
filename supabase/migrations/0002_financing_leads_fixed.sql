...
-- Lookup tables
drop policy if exists "lookup_read_all" on public.financing_categories;
drop policy if exists "lookup_read_all" on public.signal_types;
drop policy if exists "lookup_read_all" on public.industries;
drop policy if exists "lookup_read_all" on public.contact_statuses;
...
-- Financing leads
drop policy if exists "financing_leads_admin" on public.financing_leads;
drop policy if exists "financing_leads_read" on public.financing_leads;
...
-- Lead signals
drop policy if exists "lead_signals_admin" on public.lead_signals;
drop policy if exists "lead_signals_read" on public.lead_signals;
...
-- UCC filings
drop policy if exists "ucc_admin" on public.ucc_filings;
drop policy if exists "ucc_read" on public.ucc_filings;
...
-- Hiring signals
drop policy if exists "hiring_admin" on public.hiring_signals;
drop policy if exists "hiring_read" on public.hiring_signals;
...
drop policy if exists "contracts_admin" on public.government_contracts;
drop policy if exists "contracts_read" on public.government_contracts;
...
-- Equipment dealers
drop policy if exists "dealers_admin" on public.equipment_dealers;
drop policy if exists "dealers_read" on public.equipment_dealers;
...
-- Scraper jobs
drop policy if exists "scraper_jobs_admin" on public.scraper_jobs;
...
-- Shared filters
drop policy if exists "shared_filters_own" on public.shared_filters;
drop policy if exists "shared_filters_read" on public.shared_filters;
...
drop trigger if exists lead_signals_score_update on public.lead_signals;
...
drop trigger if exists equipment_dealers_updated_at on public.equipment_dealers;
